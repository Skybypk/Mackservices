  ...
  return (
    <footer className="bg-[#0A0A0B] text-gray-300">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col items-center gap-2 text-xs text-center">
          <p className="text-[#00E5FF] font-medium">© {new Date().getFullYear()} MackServices. All rights reserved.</p>
          <p className="text-[#00E5FF] font-semibold">Created by Saeed, skybypk@gmail.com</p>
        </div>
      </div>
    </footer>
  );
